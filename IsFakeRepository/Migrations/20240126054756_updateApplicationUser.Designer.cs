...
namespace IsFakeRepository.Migrations
{
    ...
    [Migration("20240126054756_updateApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserStatement", b =>
                {
                    ...
                    b.ToTable("ApplicationUserStatement");
                });
            ...
            modelBuilder.Entity("ApplicationUserStatement", b =>
                {
                    b.HasOne("IsFakeModels.Statement", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IsFakeModels.ApplicationUser", b =>
                {
                    b.HasOne("IsFakeModels.UserStatement", "UserStatement")
                        .WithOne("User")
                        .HasForeignKey("IsFakeModels.ApplicationUser", "UserStatementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserStatement");
                });

            modelBuilder.Entity("IsFakeModels.UserRecord", b =>
                {
                    b.HasOne("IsFakeModels.ApplicationUser", "User")
                        .WithMany("UserRecord")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
